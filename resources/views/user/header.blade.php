...
{{-- <header class="header">
    <nav class="navbar navbar-expand-lg fixed-top py-3">
        <div class="container">
            <a href="#" class="navbar-brand text-uppercase font-weight-bold">Online Store</a>
            ...
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto ">
                    ...
                    <li class="nav-item"><a href="#"><img style="margin-right: 15px; display:inline;" src="icon/1.png"
                                alt="#" />+2519 706 559 25</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="right_header_info">
                            ...
                            <ul class=" navbar-nav ml-auto mr-auto  " style="padding-left:0px; display:inline; "
                                style="width: 100%">
                                <li class="menu_iconb nav-item " style="display:inline;">
                                    <a href="#"><img style="margin-right: 15px; display:inline;" src="icon/1.png"
                                            alt="#" />+2519 706 559 25</a>
                                </li>


                                <li class="tytyu nav-item" style="display:inline;">
                                    <a href="#"> <img style="margin-right: 15px; display:inline;" src="icon/2.png"
                                            alt="#" /></a>
                                </li>
                                <li class="menu_iconb nav-item" style="display:inline; ">
                                    <a href="#"><img style="margin-right: 15px; display:inline; " src="icon/3.png"
                                            alt="#" /></a>
                                </li>
                                ...
                                <li class="menu_iconb nav-item" style="display:inline; ">
                                    <a href="{{ route('login') }} ">Log in <img
                                            style="margin-right: 15px; display:inline;" src="icon/login.png" alt="" />
                                    </a>
                                </li>
                                <li class="menu_iconb nav-item" style="display:inline">
