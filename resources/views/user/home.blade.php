{{-- <x-app-layout>
    <div><h1>Thsi is Normal User Dashboard</h1></div>
</x-app-layout> --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <div class="right_header_info">
                                        <ul>
                                            <li class="menu_iconb">
                                                <a href="#"><img style="margin-right: 15px;" src="icon/1.png" alt="#" />+2519 706 559 25</a>
                                            </li>
                                            <li class="menu_iconb">
                                                <a href="#">Log in <img style="margin-right: 15px;" src="icon/login.png" alt="#" /> </a>
                                            </li>
                                            <li class="menu_iconb">
                                                <a href="#">Signup<img style="margin-left: 15px;" src="icon/sign-up.png" alt="#" /></a>
                                            </li>
                                            <li class="tytyu">
